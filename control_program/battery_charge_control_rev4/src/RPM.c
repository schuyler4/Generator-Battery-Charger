...
//
// There is no guarantee that the RPM reading is accurate. It has not been tested, 
// and it is simply used to detect if the generator is on, so there is no need for 
// an accurate reading. 
//
